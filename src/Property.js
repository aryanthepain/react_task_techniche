...
const Property = () => {
  ...
  useEffect(() => {
    if (prop) {
      ...
      // prettier-ignore
      document.getElementById("fmfpic2").style.backgroundImage = `url(${prop.images[1]})`;
      // prettier-ignore
      document.getElementById("fmfpic3").style.backgroundImage = `url(${prop.images[3]})`;
    }
  }, [prop]);
          ...
          <div className="sagrid prop">
            {prop && (
              <div>
                ...
                <div>
                  <h1 className="prop sagtitle">{prop.type}</h1>
                  <div className="sagdiv prop">
                    {/* <div className="saglinkcont"> */}
                    <div className="saglink">
                      <div className="sagimgdiv">
                        {/* prettier-ignore */}
                        <img src={prop.images[0]} alt={prop.type} className="sagdimg" />
                      </div>
                      <p className="sagprice nounder">
                        Price- INR {prop.price}
                      </p>
                      <p className="sagadd nounder">Address- {prop.address}</p>
                  ...
                  <div>
                    <div className="fhead">
                      <p className="ffeature">Features</p>
                    </div>
                    <div className="fmid">
                      <div className="fmflex prop">
                        <h2 className="propfeattitle">{prop.feature2}</h2>
                        <div className="fmfpic prop" id="fmfpic1">
                          <div className="fmfdetails prop">
                            <h2 className="fmfdtitle prop">{prop.feature2}</h2>
                            <img src={prop.images[2]} className="resfmfpic" />
                          </div>
                        </div>
                        <h2 className="propfeattitle">{prop.feature1}</h2>
                        <div className="fmfpic" id="fmfpic2">
                          <div className="fmfdetails prop">
                            <h2 className="fmfdtitle prop">{prop.feature1}</h2>
                            <img src={prop.images[1]} className="resfmfpic" />
                          </div>
                        </div>
                        <h2 className="propfeattitle">{prop.feature3}</h2>
                        <div className="fmfpic prop" id="fmfpic3">
                          <div className="fmfdetails prop">
                            <h2 className="fmfdtitle prop">{prop.feature3}</h2>
                            <img src={prop.images[3]} className="resfmfpic" />
                          </div>
                        </div>
                      </div>
                    </div>
