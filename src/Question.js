      ...
      <div className="qtext">
        ...
        <div className="qtcontact qtsocial">
          ...
          <ul className="qtccon qtcsocial">
            <li className="qtcclink qtcs1">
              <a
                href="https://www.instagram.com/atp.guptaji/"
                className="nounder qtcslinka"
              >
                @myproperty
              </a>
            </li>
            <li className="qtcclink qtcs2">
              <a
                href="https://www.linkedin.com/in/aryanthepain/"
                className="nounder qtcslinka"
              >
                @myproperty
              </a>
            </li>
            <li className="qtcclink qtcs3">
              <a
                href="https://www.instagram.com/atp.guptaji/"
                className="nounder qtcslinka"
              >
