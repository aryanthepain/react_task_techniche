            ...
            data.map((prop) => (
              <div className="sagdiv" key={prop.id}>
                <Link to={`/property/${prop.id}`}>
                  {/* prettier-ignore */}
                  <img src={prop.images[0]} alt={`${prop.type} photo`} className="sagdimg" />
                  <p className="sagprice">INR {prop.price}</p>
                  <p className="sagadd">{prop.address}</p>
                  <p className="sagrent">
                    {prop.isRent && "Rent"}
                    {!prop.isRent && "Sell"}
                  </p>
                  <div className="sagddetails">
                    <div className="sagddtop">
                      <svg
                        width="23"
                        height="17"
                        viewBox="0 0 23 17"
                    ...
                    <p className="sagddbottom">Bedroom</p>
                    <div className="sagddtop">
                      <svg
                        width="20"
                        height="21"
                    ...
                    <p className="sagddbottom">Bathroom</p>
                    <div className="sagddtop">
                      <svg
                        width="21"
                        height="24"
                    ...
                    <p className="sagddbottom">Home Area</p>
                  </div>
                </Link>
              </div>
            ))}
          {!tp && data && (
            <div className="samore" onClick={HandleClick}>
              See more...
            </div>
          )}
          {tp && (
